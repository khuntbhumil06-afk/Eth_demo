...
const Confectionery = () => {
    ...
    const [activeCategory, setActiveCategory] = useState("Confectionery");
    ...
    let filteredList = Confectionery.filter((item) => {
    ...
    return (
        <>
            <div className="fruits-container">
                <h1 className="fruits-heading">Confectionery</h1>
            </div>
